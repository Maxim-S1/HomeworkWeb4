...
$experience = [
	[
    	'name' => 'Специалист технического надзора',
        'periodStart' => 'Март 2020',
        'periodFinish' => 'Hастоящее время',
        'text' => 'Контроль за качеством проведения строительных работ',
    ],
    [
    	'name' => 'Производитель работ',
        'periodStart' => 'Июнь 2017',
        'periodFinish' => 'Февраль 2020',
        'text' => 'Организация проведения строительных работ на строительном участке',
    ],
    [
    	'name' => 'Мастер работ',
        'periodStart' => 'Сентябрь 2013',
        'periodFinish' => 'Май 2017',
        'text' => 'Производство строительных работ на строительном участке',
    ],
];
?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <?php echo $experience[$i]['periodStart']?> - 
            <?php if ($i == 0):?>
            <span class="w3-tag w3-teal w3-round"><?php echo $experience[$i]['periodFinish']?></span>
             <?php else:?>
             <?php echo $experience[$i]['periodFinish']?>
             <?php endif; ?>
             </h6>
